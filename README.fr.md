...
<p align="center">
  ...
  <a href="https://github.com/thmsgo18/latex-forge-skill/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/thmsgo18/latex-forge-skill/ci.yml?branch=main&style=for-the-badge" alt="CI"></a>
...
```
Vous : /latex-forge J'ai besoin d'un rapport de projet pour une nouvelle
       fonctionnalité qu'on vient de livrer au travail. Le titre est
       "Ajout du chat en temps réel à notre application mobile", deux
       auteurs : moi et Jordan Reyes, relu par notre lead technique Priya
       Shah. Voici mes notes sur l'architecture et le déploiement : ...
