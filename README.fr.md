...
```bash
git clone https://github.com/thmsgo18/latex-forge-claude-skill.git /tmp/latex-forge-claude-skill
mkdir -p ~/.claude/skills
cp -r /tmp/latex-forge-claude-skill/latex-forge ~/.claude/skills/
rm -rf /tmp/latex-forge-claude-skill
```
